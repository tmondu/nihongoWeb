 ...
 */
export type Namespace = 'common' | 'navigation' | 'kana' | 'kanji' | 'vocabulary' | 'achievements' | 'statistics' | 'settings' | 'errors' | 'menuInfo' | 'blog' | 'translator' | 'metadata' | 'faq' | 'practiceLanding' | 'welcome' | 'experiments' | 'legal' | 'kanaChart' | 'conjugator' | 'resources';
