...
export function parseAikenFormat(text: string): ExerciseQuestion[] {
  ...
  for (const segment of segments) {
    ...
    for (const block of rawBlocks) {
      ...
      // Check if block or first line is a Part/Section header e.g. [PART: Bài 1] or ### Bài 2
      const partMatch =
        trimmedBlock.match(
      ...
      for (let i = 0; i < lines.length; i++) {
        ...
        // Check if a line inside the block is a [PART: ...]
...
"Chọn cách đọc đúng của chữ Hán: 先生","せんせい","がくせい","いしゃ","かいしゃいん","A","先生 đọc là せんせい, có nghĩa là giáo viên.","Bài 1"
"Điền từ thích hợp vào chỗ trống: わたし___ ベトナム人です。","を","に","は","で","C","は là trợ từ chỉ chủ ngữ trong câu khẳng định cơ bản.","Bài 2"
"Ý nghĩa của câu 'ありがとうございます' là gì?","Xin lỗi","Cảm ơn","Tạm biệt","Chúc ngủ ngon","B","ありがとうございます có nghĩa là Cảm ơn rất nhiều.","Bài 2"`;
}
