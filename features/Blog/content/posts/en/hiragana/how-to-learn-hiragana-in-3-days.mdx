...
2. **Practice app** - [PThamSS](https://www.pthamnihongo.site) or similar interactive tool
...
Use [PThamSS's training mode](https://www.pthamnihongo.site/en/kana/train) to:
...
- Use PThamSS's blitz mode daily
...
1. **[PThamSS](https://www.pthamnihongo.site)** - Interactive games, progress tracking, 100+ themes
...
- **PThamSS** (Web, iOS, Android) - Best for gamified learning
...
> "I combined this guide with PThamSS's interactive games. The gamification kept me motivated, and the progress tracking showed me exactly where I needed more practice." - Kenji L., Singapore
...
<InfoBox type='success'>
  Ready to start? Head to [PThamSS's Hiragana
  Training](https://www.pthamnihongo.site/en/kana/train) and begin your 3-day
